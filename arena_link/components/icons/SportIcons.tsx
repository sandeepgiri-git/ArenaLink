...
export function BasketballIcon({ className = "", size = 24 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M2 12h20" />
      <path d="M12 2v20" />
      <path d="M4.93 4.93c4.08 2.45 6.45 6.45 6.45 6.45" />
      <path d="M19.07 4.93c-4.08 2.45-6.45 6.45-6.45 6.45" />
      <path d="M4.93 19.07c4.08-2.45 6.45-6.45 6.45-6.45" />
      <path d="M19.07 19.07c-4.08-2.45-6.45-6.45-6.45-6.45" />
    </svg>
  );
}
...
export function TennisIcon({ className = "", size = 24 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M5.636 5.636A9 9 0 0 1 18.364 18.364" />
    </svg>
  );
}
...
export function BadmintonIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12.5 3.5 L18 9 L14.5 12.5 L9 7 Z" />
      <line x1="9" y1="7" x2="3" y2="13" />
      <line x1="14.5" y1="12.5" x2="9" y2="18" />
